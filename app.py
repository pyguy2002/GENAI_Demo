...
def main():
    ...
    if user_input:
        ...
        index=pull_from_pinecone("e5654078-a3b7-4ed1-adb8-6888c2bb4f0d","gcp-starter","project10",embeddings)

        #"e5654078-a3b7-4ed1-adb8-6888c2bb4f0d","gcp-starter","project10"
